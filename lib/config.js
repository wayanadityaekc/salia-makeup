...
// Layanan hairdo (kategori sendiri — tiap jenis satu card, diedit di dashboard)
export const hairdo = [
  {
    id: "hairdo-simpel",
    nama: "Hairdo Simpel",
    ringkas: "Penataan rambut rapi untuk sehari-hari / kerja.",
    base: 100000,
  },
  {
    id: "hairdo-pesta",
    nama: "Hairdo Pesta",
    ringkas: "Sanggul / tatanan elegan untuk acara & pesta.",
    base: 150000,
  },
  {
    id: "hairdo-adat",
    nama: "Sanggul Adat",
    ringkas: "Sanggul khas untuk upacara & adat Bali.",
    base: 200000,
  },
];
...
// Lookup gabungan semua kategori
export const allServices = [...services, ...hairdo, ...nailArt];
